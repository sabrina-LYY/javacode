...
public class User {
    ...
    public static User register(String username, String nickname, String password) throws SQLException {
        //把密码hash后保存进数据库，防止因为数据库拖库导致用户密码泄露
        //以前用MD5--现在常用sha264
    ...
    public static User getByUsername(String username) throws ParseException, SQLException {
        String sql = "SELECT id,username,nickname,brief,register_at FROM users WHERE username = ?";
        User user = null;
