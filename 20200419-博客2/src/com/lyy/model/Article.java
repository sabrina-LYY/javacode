...
public class Article {
    ...
    public static Article publish(User user,String coverImageUrl, String title, String body) throws SQLException {
    ...
    public static Article getById(int id) throws SQLException {
        String sql = "SELECT id,cover_image,title,body,published_at FROM articles WHERE id=?";
        try(Connection con = Database.getConnection()){
    ...
    public static List<Article> list() throws SQLException {
        String sql = "SELECT id,cover_image,title,body FROM articles ORDER BY id DESC";
